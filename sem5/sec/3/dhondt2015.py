...
for row in data:
 ...
 #   row = data[0]
    ...
    okrName = row["FIELD2"]
    okrSeats = row["FIELD3"]
    votesInvalid = row["FIELD22"]
    votesValid = row["FIELD26"]
    votesOut = row["FIELD29"] + row["FIELD30"] + row["FIELD32"] + row["FIELD35"] + row["FIELD36"] + row["FIELD37"] + row["FIELD38"] + row["FIELD39"] + row["FIELD40"] + row["FIELD41"] + row["FIELD42"] + row["FIELD43"]
